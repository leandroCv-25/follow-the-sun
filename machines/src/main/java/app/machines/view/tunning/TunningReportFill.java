...
public class TunningReportFill {
		
		@SuppressWarnings({ "unchecked", "rawtypes" })
		public TunningReportFill(Machine machine) {
			
			
			JasperDesign desenho;
			try {
				desenho = JRXmlLoader.load(getClass().getResourceAsStream("/report/tunning.jrxml"));
		    	...
		    	impressao.setName("TunningReport");
